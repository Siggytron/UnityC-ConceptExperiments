...
public class ReactionJointExperiment : MonoBehaviour
{
    Animator animatorA;
    Animator animatorB;
    bool firstCollide;
    ...
    {
        if (other.gameObject.GetComponent<Collider>().name == "ColliderObjectB")
        {
            thisobj = this.gameObject;
            otherobj = other.gameObject;
            thisparent = thisobj.transform.parent.gameObject;
            print(thisparent + "thisparent");
        
            otherparent = otherobj.transform.parent.gameObject;
            print(otherparent + "otherparent");

            otherparent.GetComponent<MoveJointExperiment>().enabled = false;
            thispos = this.gameObject.transform.position;
            otherpos = other.gameObject.transform.position;
            fj = thisparent.AddComponent<FixedJoint>();
            //otherrb = otherparent.GetComponent<Rigidbody>();
            fj.connectedBody = otherparent.GetComponent<Rigidbody>();
            ...
            //print("other.gameObject:" + other.gameObject);
    ...
    private void FixedUpdate()
    {
        ...
        {
            rb = GameObject.Find("parentSubstrateA").GetComponent<Rigidbody>();
            print(rb + "rb");
        }
    }
    void StateCntllr()
